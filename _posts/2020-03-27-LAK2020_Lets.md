...
<p><img src="https://github.com/AngusGLChen/angusglchen.github.io/blob/master/_posts/2020-03-27-LAK2020_Lets_imgs/Table1.png?raw=True" width="1100px"></p>

#### Results on RQ2: Difference of the investigated topics

The overall T-Scores, which can be regarded as a proxy of the efforts allocated by authors for different topics, are provided in Fig. 2, which shows the LAK authors dedicated more attention to the research of **T2 (Engagement Patterns & Resource Use)** and **T6 (Effects on Teaching & Learning Practices)**, while EDM researchers put more emphasis on **T1 (Predictive & Descriptive Analytics)** and **T4 (Knowledge & Skill Modeling)**.
...
<p><img src="https://github.com/AngusGLChen/angusglchen.github.io/blob/master/_posts/2020-03-27-LAK2020_Lets_imgs/Table4.png?raw=True" width="1100px"></p>
